...
<div class="container-fluid">
    <div class="row" >
        ...
        <div class="col-5 mt-3 mb-3 ml-3" >
            <div class="col-12  mb-3 leftColName">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="row">
                                    <div class="col-6 topic">
                                        ${Subscription.countByUser(u)}
                                    </div>

                                    <div class="col-6 topic">
                                        ${Topic.countByCreatedBy(u)}
                                    </div>
                                </div>
            ...
            <div class="col-12 leftCol2 mb-3">

                <div class="col-12 ">
                    <nav class="navbar navbar-light bg-light ">
                        <h5><strong>Subscriptions</strong></h5>
                ...
                <div class="col-12 ">
                    <table class="table ">
                        ...
                        <g:if test="${Subscription.findAllByUser(u)== null}">

                        </g:if>

                        <g:else>
                            <g:each in="${Subscription.findAllByUser(u)}" var="num">
                                <g:if test="${num.user == num.topic.createdBy}" >
                                    <tr class="subTr">
                                        <td>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        <g:link controller="topic" action="topicsShow" params="[id:num.topic.id]">${num.topic.name}</g:link>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 centerAl">
                                                                ${Subscription.countByTopic(Topic.findByCreatedBy(u))}
                                                            </div>

                                                            <div class="col-4 centerAl">
                                                                ${Resource.countByTopic(num.topic)}
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 ">
                                                                <g:form controller="subscription" action="changeSeriousness" params="[id: num.topic.id]">

                                                                    <select class="form-control form-control-sm" name="serious" onchange="this.form.submit()">
                                                                        <g:if test="${num.seriousness== Seriousness.SERIOUS}">
                                                                            <option value="casual">Casual</option>
                                                                            <option value="serious" selected>Serious</option>
                                                                            <option value="very serious">Very serious</option>
                                                                        </g:if>

                                                                        <g:elseif test="${num.seriousness== Seriousness.CASUAL}">
                                                            ...
                                                            <div class="col-4 selects">
                                                                <g:form controller="topic" action="changePrivacy"  params="[id: num.topic.id]">
                                                                    <g:if test="${num.topic.visibility== Visibility.PRIVATE}">
                                                            ...
                                                            <div class="col-3">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-4">
                                                                        ...
                                                                        <a href="#" data-toggle="modal" data-target="#sendInvitations" data-val="${num.topic.name}">
                                                                    ...
                                                                    <div class="col-4">
                                                                        ...
                                                                        <g:link controller="topic" action="delete" params="[id:num.topic.id]">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                <g:link controller="subscription" action="unsubscribe" params="[id:num.topic.id]" style=" text-decoration: underline;">Unsubscribe</g:link>
                                                            </div>

                                                            <div class="col-4 centerAl">
                                                                ${Subscription.countByTopic(num.topic)}
                                                            </div>
            ...
            <div class="col-12 trendingTopics mb-2">
                <div class="col-12 ">
                ...
                <div class="col-12">
                    <table class="table">
                        ...
                        <g:if test="${Topic.findAllByCreatedBy(u)==null}">
                ...
                <div class="col-12">
                    ...
                    <table class="table mb-0">
                        ...
                        <g:each in="${Resource.list()}" var="res">
                            <g:if test="${ReadingItem.findByUserAndResource(u,res) && !ReadingItem.findByUserAndResource(u,res).isRead}">
                                <tr>
                                    <td>
                                        <div class="col-12 ">
