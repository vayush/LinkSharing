...
<div class="col-12  mt-4 mb-2 leftCol2">
    <div class="col-12 ">
    ...
    <div class="col-12 ">
        <table class="table ">
            <tbody>
            <g:each in="${Subscription.findAllByUser(u)}" var="sub">
                <g:if test="${sub.user == sub.topic.createdBy}" >
                    <tr>
                        <td>
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        <g:link controller="topic" action="topicsShow" params="[id:sub.topic.id]">${sub.topic.name}</g:link>
                                        <div class="row">
                                            <div class="col-2">
                                            ...
                                            <div class="col-2 ">
                                                <div class="row">
                                                    Post :
                                                    ${Resource.countByTopic(sub.topic)}
                                                </div>
                                            </div>
                                            <div class="col-2 ">
                                                <g:form controller="subscription" action="changeSeriousness" params="[id: sub.topic.id]">
                                                    ...
                                                    <select class="form-control form-control-sm" name="serious" onchange="this.form.submit()">
                                                        <g:if test="${sub.seriousness== Seriousness.SERIOUS}">
                                                            <option value="casual">Casual</option>
                                                            <option value="serious" selected>Serious</option>
                                                            <option value="very serious">Very serious</option>
                                                        </g:if>

                                                        <g:elseif test="${sub.seriousness== Seriousness.CASUAL}">
                                            ...
                                            <div class="col-2">
                                                <g:form controller="topic" action="changePrivacy"  params="[id: sub.topic.id]">
                                                    <g:if test="${sub.topic.visibility== Visibility.PRIVATE}">
                                            ...
                                            <div class="col-2">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <a href="#" data-toggle="modal" data-target="#sendInvitations" data-val="${sub.topic.name}">
                                                    ...
                                                    <div class="col-4">
                                                        <g:link controller="topic" action="delete" params="[id:sub.topic.id]">
                                    ...
                                    <div class="col-11">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <div class="row">
                                                    Subscription:
                                                    ${Subscription.countByTopic(sub.topic)}
                                                </div>
                                            </div>
                                            <div class="col-2 ">
                                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <g:link controller="subscription" action="unsubscribe" params="[id:sub.topic.id]" style=" text-decoration: underline;">Unsubscribe</g:link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
