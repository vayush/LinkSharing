            ...
            <div class="col-12 mt-3 ml-2 leftCol2">
                ...
                <div class="col-12 ">
                    <table class="table ">
                        ...
                        <g:if test="${t.createdById==(session.getAttribute("user0") as User).id}" >
                            <tr>
                                <td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 selects">
                                                        <g:form controller="topic" action="changePrivacy"  params="[id: t.id]">
                                                            <g:if test="${t.visibility== Visibility.PRIVATE}">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                <a href="#" data-toggle="modal" data-target="#sendInvitations" data-val="${t.name}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <g:if test="${t.createdBy.userName == u.userName}">

                                                        </g:if>
                                                        <g:elseif test="${Subscription.findByTopicAndUser(t,u)}">
